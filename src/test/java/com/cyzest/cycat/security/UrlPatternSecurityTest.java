...
public class UrlPatternSecurityTest {
    ...
    public void directoryUrlPatternSecurityTest() throws Exception {
        ...
        Assert.assertTrue(directoryUrlPatternSecurity.validate("/main/resources/config.json"));
        Assert.assertTrue(directoryUrlPatternSecurity.validate("/main/resources/"));
        Assert.assertTrue(directoryUrlPatternSecurity.validate("/../src/main/resources/config.json"));
